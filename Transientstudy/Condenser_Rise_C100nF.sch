...
<Properties>
  <View=0,61,1205,988,1,0,60>
  <Grid=10,10,1>
  <DataSet=P1EP_Ej1_c100nf.dat>
  <DataDisplay=P1EP_Ej1_c100nf.dpl>
  <OpenDisplay=1>
  <Script=P1EP_Ej1_c100nf.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Título>
...
<Components>
  ...
  <C C1 1 760 390 17 -26 0 1 "100 nF" 1 "" 0 "neutral" 0>
</Components>
<Wires>
