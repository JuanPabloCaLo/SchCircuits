...
<Properties>
  <View=0,-408,1187,560,1,0,0>
  <Grid=10,10,1>
  <DataSet=P4_ConstanteTiempomuchomayor2.dat>
  <DataDisplay=P4_ConstanteTiempomuchomayor2.dpl>
  <OpenDisplay=1>
  <Script=P4_ConstanteTiempomuchomayor2.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Título>
...
<Components>
  ...
  <R R1 1 520 -200 -26 15 0 0 "1 Ohm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "US" 0>
...
<Wires>
  ...
  <450 -270 450 -250 "" 0 0 0 "">
  <450 -250 570 -250 "" 0 0 0 "">
  <570 -200 620 -200 "" 0 0 0 "">
  <570 -250 570 -200 "" 0 0 0 "">
</Wires>
<Diagrams>
  <Rect 100 319 1015 259 3 #c0c0c0 1 00 1 0 0.2 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 "" "" "">
	<"Io1.It" #0000ff 0 3 0 0 0>
  </Rect>
  <Rect 90 540 1036 148 3 #c0c0c0 1 00 1 0 0.2 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 "" "" "">
